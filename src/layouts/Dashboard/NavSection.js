          ...
          <List key={subheader} disablePadding>
            ...
            {items.map((item) => (
              <> 
                ...
                {
                  item.title === "Stake Now" || item.title === "Land Sale"
                  ?
                    <Badge badgeContent="New" sx={{backgroundColor:"#f00", color:'#f00', position:'relative', top:'-35px', right:'-163px', fontSize:'12px', fontWeight:'bolder', display:'inline'}}></Badge>
                  :''
                }
              </>
            ))}
